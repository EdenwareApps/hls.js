import type { AttachMediaSourceData, BaseTrackSet, BufferCreatedTrackSet, MediaOverrides, ParsedTrack, SourceBufferName, SourceBufferTrackSet } from './buffer';
...
import type { HdcpLevel, HlsUrlParameters, Level, LevelAttributes, LevelParsed, VariableMap } from './level';
...
import type { InterstitialScheduleDurations, InterstitialScheduleItem } from '../controller/interstitials-schedule';
import type { HlsListeners } from '../events';
import type { Fragment, MediaFragment, Part } from '../loader/fragment';
import type { AssetListJSON, InterstitialAssetItem, InterstitialEvent, InterstitialEventWithAssetList } from '../loader/interstitial-event';
